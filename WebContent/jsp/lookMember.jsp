...
<object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="400" height="200">
  <param name="movie" value="flash/look.swf" />
  ...
  <!--[if !IE]>-->
  <object type="application/x-shockwave-flash" data="flash/look.swf" width="400" height="200">
    <!--<![endif]-->
    <param name="quality" value="high" />
    <param name="wmode" value="opaque" />
    <param name="swfversion" value="6.0.65.0" />
...
<form action="FindMember" method="post">
	<br/>输入要查找的会员名:<input type="text" name="name"/>
